...
def includeme(config):
    ...
    config.add_route('admin_oauth', '/admin/oauth')
    config.add_route('admin_oauth_create', '/admin/oauth/new')
    config.add_route('admin_oauth_edit',
                     '/admin/oauth/{id}',
                     factory='h.models.auth_client.AuthClientFactory',
                     traverse='/{id}')
