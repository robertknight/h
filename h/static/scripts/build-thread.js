...
var defaultOpts = {
  ...
  // Predicate function that returns true if an annotation should be visible
  searchFilter: undefined,
  // List of IDs of annotations that be expanded to show their replies
  expanded: [],
  // Function used to compare annotations in order to sort the
  // top-level thread.
